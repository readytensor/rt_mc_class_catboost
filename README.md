...
- A **Catboost Classifier** multiclass algorithm built using **catboost** python package.
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the Catboost Multiclass Classifier model implemented using **catboost** python library.
